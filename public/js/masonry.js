...
$(document).ready(function() {
  function dposhak_masonry($masonry)
  {
  ...
  $('.dposhak-masonry').each(function () {
    ...
    $('.masonry_fillter .item-fillter').on( 'click', function() {
      ...
      $(this).closest('.dposhak-masonry').find('.masonry_fillter .item-fillter').removeClass('fillter-active');
